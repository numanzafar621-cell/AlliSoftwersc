...
<style>
*{box-sizing:border-box;} body{margin:0;font-family:Arial;background:#f1f3f6;}
...
h2{margin:5px 0;} input{width:100%;padding:10px;border:1px solid #ccc;border-radius:5px;margin-top:8px;}
